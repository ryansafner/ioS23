        ...
        mainPanel(
           ...
           p("Made with",
             ...
             a("Industrial Organization",
               href="http://ios23.classes.ryansafner.com"),
...
server <- function(input, output) {
    ...
    output$printgrades <- renderText({
        coursegrade<-round(((input$disc*2)+(input$profile*0.20)+(input$hw*0.20)+(input$midterm*0.20)+(input$final*0.3)),4)
