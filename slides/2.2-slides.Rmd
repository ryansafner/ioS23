...
\left(\frac{3-0.5}{N+1}\right)^2\frac{1}{0.05}& =10.00 \\
N^* &= 5.36 \\ \end{align*}$$
]
...
$$\begin{align*}\pi &= f \\
\left(\frac{a-c}{N+1}\right)^2 \left(\frac{1}{b}\right)&=f \\
\left(\frac{3-0.5}{N+1}\right)^2\frac{1}{0.05}& =75.00 \\
N^* &= 1.32 \\ \end{align*}$$
]
...
- Implication: .hi-turquoise[if Cournot model is accurate, measuring the $HHI$ and $\epsilon$ provide good empirical evidence about firm conduct]
