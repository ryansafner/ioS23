...
.center\[ ![:scale 80%](https://www.dropbox.com/s/kzv1hjt3cpf3emy/Bertrandmoblab.png?raw=1)\]

------------------------------------------------------------------------

# Bertrand Competition: Moblab

.pull-left\[ - Each of you selling identical Economics course notes
...
.pull-right\[ .center\[ ![](https://www.dropbox.com/s/kzv1hjt3cpf3emy/Bertrandmoblab.png?raw=1)\]
...
.pull-left\[ $$q=3600-200p_L$$

.hi-green\[Example:\] - Suppose Firm 1 sets $p=9$ and Firm 2 sets $p=10$
...
1822-1890 \] \] \] .right-column\[ - .hi\["Bertrand competition"\]: two (or more) firms compete on **price** to sell the **same good**
...
.pull-right\[ .center\[ ![](../images/cokepepsi.jpg)\]\]

------------------------------------------------------------------------

# Bertrand Competition: Example

.pull-left\[ - Demand for soda from .hi-red\[Coke\]:
...
.pull-left\[ - Demand for soda from .hi-red\[Coke\]: - $Q$ if .red\[`\\(p_c\\)`\] $<$ .blue\[`\\(p_p\\)`\]\]

------------------------------------------------------------------------

# Bertrand Competition: Example

.pull-left\[ - Demand for soda from .hi-red\[Coke\]: - $Q$ if .red\[`\\(p_c\\)`\] $<$ .blue\[`\\(p_p\\)`\] - $\frac{Q}{2}$ if .red\[`\\(p_c\\)`\] $=$ .blue\[`\\(p_p\\)`\]\]

------------------------------------------------------------------------

# Bertrand Competition: Example

.pull-left\[ - Demand for soda from .hi-red\[Coke\]: - $Q$ if .red\[`\\(p_c\\)`\] $<$ .blue\[`\\(p_p\\)`\] - $\frac{Q}{2}$ if .red\[`\\(p_c\\)`\] $=$ .blue\[`\\(p_p\\)`\] - $0$ if .red\[`\\(p_c\\)`\] $>$ .blue\[`\\(p_p\\)`\]\]
...
.pull-left\[ - Demand for soda from .hi-blue\[Pepsi\]: - $0$ if .red\[`\\(p_c\\)`\] $<$ .blue\[`\\(p_p\\)`\] - $\frac{Q}{2}$ if .red\[`\\(p_c\\)`\] $=$ .blue\[`\\(p_p\\)`\] - $Q$ if .red\[`\\(p_c\\)`\] $>$ .blue\[`\\(p_p\\)`\]\]
...
.content-box-green\[.hi-green\[Example\]: Continue your example with Firm 1 and Firm 2, who still have a constant $MC=AC=8$. The market (inverse) demand curve is again given by:
...
.left-column\[ .center\[ ![:scale 80%](../images/Bertrand.jpg)

.smaller\[ Joseph Bertrand

1822-1890 \] \] \]

.right-column\[ - The paradox happens due to pretty strict assumptions about the model - Homogeneous goods; consumers *only* buy from the lower-priced seller - No capacity constraints
...
.pull-left\[ .smaller\[ - Now consider instead of homogenous goods, each seller is selling differentiated products (i.e. imperfect substitutes) - Consumers have preferences between Coke and Pepsi

-   Same assumptions of Bertrand model:
    -   Firms set their own prices simultaneously
-   But now each firm faces its own downward-sloping demand curve \] \] .pull-right\[ .center\[ ![](../images/cokepepsi.jpg)\]\]
...
-   Suppose the demand for Coke and for Pepsi, respectively, are: $$q_c = 1.00-0.25p_c+0.25p_p \\
...
Suppose each firm can only supply, at most, $q_1 \leq k_1$ and $q_2 \leq k_2$, where $k_1 + k_2 \leq \frac{a}{b}$ (horizontal intercept, max production) - implies that firms' can't "flood" the market (and send the price to \$0)
...
$$MR_1(q_1,q_2) = P(Q) + \frac{\Delta P(Q)}{\Delta Q} \frac{\Delta Q}{\Delta q_1}q_1$$ - $\frac{\Delta Q}{\Delta q_1}$ is the rate of change in *industry* output that firm 1 expects when it increases its output - $\Delta Q = \Delta q_1 + \frac{\Delta q_2}{\Delta q_1} \Delta q_1$ - where $\frac{\Delta q_2}{\Delta q_1}$ is Firm 1's .hi-purple\[conjecture\] about how Firm 2 will respond to Firm 1's output change. - Divide everything by $\Delta q_1$:
...
$$MR_1(q_1,q_2) = P(Q) + \frac{\Delta P(Q)}{\Delta Q} (1+ \nu_1)q_1$$ - Equilibrium: each firm is profit-maximizing, given its conjecture about its rival
...
If $\nu = 0$: $a-2bq_1-bq_2$ Cournot If $\nu = -1$: $a-bq_1-bq_2$ Bertrand (Demand = MC) If $\nu = 1$: $a-3bq_1-bq_2$ Monopoly ---
...
-   $\nu = -1$: the Bertrand conjecture; firm is a price-taker, setting $p=MC$<sup>.magenta\[‡\]</sup> $$P(Q)  = MC(q_1)$$
